...
import crawlee.org.src.crawler.worker.CrawlerWorker;
...
public class Crawler {
    ...
    public synchronized void saveParsedDocument(ScrapedDocument scrapedDocument) {
        log.info(String.format("Saving document with content: %s", scrapedDocument.content().toString()));
